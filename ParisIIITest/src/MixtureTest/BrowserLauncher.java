 ...
 * <p>
 * Credits:
 * <br>Steven Spencer, JavaWorld magazine (<a target=_top href="http://www.javaworld.com/javaworld/javatips/jw-javatip66.html">Java Tip 66</a>)
   ...
   // System.out.println(jvm);
    switch (jvm) {
      ...
      case MRJ_3_1:
        ...
        break;
      case WINDOWS_NT:
        Process processNT = Runtime.getRuntime().exec(new String[] { (String)
            browser,
      ...
      case WINDOWS_9x:
        ...
        // characters to work.
//                                throw new IOException((String) browser+FIRST_WINDOWS_PARAMETER+SECOND_WINDOWS_PARAMETER+THIRD_WINDOWS_PARAMETER+'"' + url + '"');
        //    System.out.println((String) browser+FIRST_WINDOWS_PARAMETER+SECOND_WINDOWS_PARAMETER+THIRD_WINDOWS_PARAMETER+url);
        ...
        Process process = Runtime.getRuntime().exec(new String[] { (String)
            browser, FIRST_WINDOWS_PARAMETER,
